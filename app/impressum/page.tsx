  ...
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-container mx-auto px-6">
          <div className="max-w-2xl space-y-10 font-body text-[#374151]">

            <div>
              <h2 className="font-display font-bold text-[22px] text-[#111827] mb-4">
            ...
            <div>
              ...
              <p className="text-[16px] leading-[1.8] mt-3">
