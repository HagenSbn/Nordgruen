            ...
            {standorte.map((s, i) => (
              ...
              >
                <Link
                  ...
                  className="group flex flex-col h-full bg-white border border-[#e5e7eb] rounded-[12px] p-7 hover:border-[#309c30] hover:shadow-md transition-all"
                >
                  ...
                  <h2 className="font-display font-bold text-[22px] text-[#111827] mb-1 group-hover:text-[#309c30] transition-colors">
                    {s.name}
                  </h2>
      ...
      <section className="py-16 bg-[#f0faf0]">
        <div className="max-w-container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="font-display font-bold text-[28px] text-[#111827] mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/#kontakt"
                className="bg-[#309c30] hover:bg-[#1e6b1e] text-white font-semibold px-7 py-3.5 rounded-[6px] transition-all hover:scale-[1.02] font-body text-[15px]"
              >
                Anfrage stellen
              </Link>
              <a
                href="tel:041212633100"
                className="border border-[#309c30] text-[#309c30] font-semibold px-7 py-3.5 rounded-[6px] hover:bg-[#f0faf0] transition-all font-body text-[15px]"
              >
                04121 2633100
              </a>
            </div>
